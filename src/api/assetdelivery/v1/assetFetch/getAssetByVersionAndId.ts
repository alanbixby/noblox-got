 ...
 * @return OK TODO:
 */
export async function getAssetByVersionAndId(
  client: NobloxClient,
  assetId: number,
  version: number,
  ...
  return await client.http<IAssetResponseItem>(
    `https://assetdelivery.roblox.com/v1/assetId/${assetId}/version/${version}`,
    {
      method: 'GET',
      context: {
