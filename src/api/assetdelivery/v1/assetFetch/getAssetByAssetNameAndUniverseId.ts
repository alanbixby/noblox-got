 ...
 * @param alias TODO: DESCRIPTION HERE
 ...
 * @return OK TODO:
 */
export async function getAssetByAssetNameAndUniverseId(
  client: NobloxClient,
  alias: string,
  ...
  return await client.http<IAssetResponseItem>(`https://assetdelivery.roblox.com/v1/alias/${alias}`, {
    method: 'GET',
    context: {
